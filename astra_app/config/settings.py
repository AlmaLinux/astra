...
ELECTION_REKOR_ENDPOINT: str = os.environ.get("ELECTION_REKOR_ENDPOINT", "")
ELECTION_LIFECYCLE_AUTOMATION_ENABLED: bool = os.environ.get(
    "ELECTION_LIFECYCLE_AUTOMATION_ENABLED", "true"
).lower() in {"1", "true", "yes", "on"}
ELECTION_REKOR_SIGNING_KEY: str = os.environ.get("ELECTION_REKOR_SIGNING_KEY", "")
ELECTION_REKOR_RETRY_COUNT: int = int(os.environ.get("ELECTION_REKOR_RETRY_COUNT", "2"))
ELECTION_REKOR_TIMEOUT_SECONDS: int = int(os.environ.get("ELECTION_REKOR_TIMEOUT_SECONDS", "5"))
...
ELECTION_RATE_LIMIT_BALLOT_VERIFY_WINDOW_SECONDS = _env_int(
    "ELECTION_RATE_LIMIT_BALLOT_VERIFY_WINDOW_SECONDS",
    default=60,
)

ELECTION_RATE_LIMIT_VOTE_SUBMIT_LIMIT = _env_int(
    "ELECTION_RATE_LIMIT_VOTE_SUBMIT_LIMIT",
    default=20,
)
ELECTION_RATE_LIMIT_VOTE_SUBMIT_WINDOW_SECONDS = _env_int(
    "ELECTION_RATE_LIMIT_VOTE_SUBMIT_WINDOW_SECONDS",
    default=60 * 60,
)

ELECTION_RATE_LIMIT_CREDENTIAL_RESEND_LIMIT = _env_int(
    "ELECTION_RATE_LIMIT_CREDENTIAL_RESEND_LIMIT",
    default=10,
)
ELECTION_RATE_LIMIT_CREDENTIAL_RESEND_WINDOW_SECONDS = _env_int(
    "ELECTION_RATE_LIMIT_CREDENTIAL_RESEND_WINDOW_SECONDS",
    default=10 * 60,
)

# Membership workflow
MEMBERSHIP_EXPIRING_SOON_DAYS = _env_int("MEMBERSHIP_EXPIRING_SOON_DAYS", default=90)
MEMBERSHIP_VALIDITY_DAYS = _env_int("MEMBERSHIP_VALIDITY_DAYS", default=365)
MEMBERSHIP_STATS_APPROVAL_OUTLIER_DAYS = _env_int("MEMBERSHIP_STATS_APPROVAL_OUTLIER_DAYS", default=180)
MEMBERSHIP_STATS_RETENTION_COHORTS_LIMIT = _env_int("MEMBERSHIP_STATS_RETENTION_COHORTS_LIMIT", default=24)
...
MEMBERSHIP_REQUEST_RENEWAL_APPROVED_EMAIL_TEMPLATE_NAME = _env_str(
    "MEMBERSHIP_REQUEST_RENEWAL_APPROVED_EMAIL_TEMPLATE_NAME",
    default="membership-renewal-approved",
)
...
ACCOUNT_DELETION_APPROVED_EMAIL_TEMPLATE_NAME = _env_str(
    "ACCOUNT_DELETION_APPROVED_EMAIL_TEMPLATE_NAME",
    default="account-deletion-approved",
)
...
MEMBERSHIP_NOTES_RESUBMITTED_DIFFS_ENABLED = _env_bool(
    "MEMBERSHIP_NOTES_RESUBMITTED_DIFFS_ENABLED",
    default=True,
)
...
ORGANIZATION_CLAIM_TOKEN_TTL_SECONDS = _env_int(
    "ORGANIZATION_CLAIM_TOKEN_TTL_SECONDS",
    default=int(datetime.timedelta(days=7).total_seconds()),
)
