...
def update_election_vote_receipt_template_manifest_digest_copy(apps: Any, schema_editor: Any) -> None:
    del schema_editor
    ...
    html_content = (
        ...
        "<hr>\n"
        "<h3>Election definition checkpoint</h3>\n"
        "<p><strong>Election definition digest:</strong><br/><code>{{ config_manifest_sha256 }}</code></p>\n"
        "<p>This digest is the frozen election definition at start. Compare this digest with the public audit log and the ballot verification page if you need to confirm the election definition that your ballot was recorded under.</p>\n"
        "<hr>\n"
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0097_election_manifest_chain_fields"),
        ("post_office", "0013_email_recipient_delivery_status_alter_log_status"),
    ]

    operations = [
        migrations.RunPython(
            update_election_vote_receipt_template_manifest_digest_copy,
