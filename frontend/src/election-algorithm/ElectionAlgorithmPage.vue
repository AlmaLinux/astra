...
defineProps<{
  bootstrap: ElectionAlgorithmBootstrap;
}>();
</script>

<template>
  <div data-election-algorithm-vue-root>
      ...
      <div class="col-md-10 col-lg-9">
        <div class="card card-outline card-info">
          ...
          <div class="card-body">
            ...
            <p>Meek STV is a way to elect multiple winners using ranked ballots.</p>
            <ul>
            ...
            <p>Our system uses a high-precision, deterministic implementation:</p>
            <ul>
            ...
            <p>Compared to simpler STV methods:</p>
            <ul>
            ...
            <p>Compared to floating-point implementations:</p>
            <ul>
            ...
            <p>You can verify an election in three main ways:</p>
            ...
            <p>Trust is built from repeatability and transparency:</p>
            <ul>
            ...
            <p>
              For a deep dive into the algorithm, ballot receipt model, privacy guarantees, and security properties, see the
              <a :href="bootstrap.runbookUrl" target="_blank" rel="noopener noreferrer">Meek STV elections runbook</a>
              on GitHub.
            </p>
          </div>
        </div>
