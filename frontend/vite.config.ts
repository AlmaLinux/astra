  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        groups: fileURLToPath(new URL("./src/entrypoints/groups.ts", import.meta.url)),
        groupDetail: fileURLToPath(new URL("./src/entrypoints/groupDetail.ts", import.meta.url)),
        groupForm: fileURLToPath(new URL("./src/entrypoints/groupForm.ts", import.meta.url)),
